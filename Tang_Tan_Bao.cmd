...
::  To activate Office with BaoTaoBao, run the script with "/Ohook" parameter or change 0 to 1 in below line
set _act=0

::  To remove BaoTaoBao, run the script with /Ohook-Uninstall parameter or change 0 to 1 in below line
set _rem=0
...
echo BaoTaoBao is supported only on Windows 8/10/11 and their server equivalents.
echo:
...
if %_unattended%==0 (
    ...
    echo         ____________________________________________________________
    echo: 
    call :dk_color2 %_White% "             " %_Cyan% "Duoc lam boi BaoTaoBao"
...
::  Clear the vNext/shared/device license blocks which may prevent BaoTaoBao
